...
def log_startup():
    log.info("=" * 50)
    log.info(f"KRONYX v2.0.0 Starting")
    log.info(f"Environment: {ENVIRONMENT}")
    log.info(f"5 Elite Pillars active")
    log.info(f"18 Network and Platform Systems active")
    log.info(f"5 God Level Systems active")
    log.info("=" * 50)
